...
def get_gv_and_model_prep_instances(args):
    ...
    model_prep_kws = {"df_dhss_in_roi": copy.deepcopy(gv.df_dhss_in_roi),
                      "gene_ofInterest_info": gv.gene_ofInterest_info,
                      "gene_ofInterest": gv.gene_ofInterest,
                      "df_gencode_all_mrnas": gv.df_gencode_all_mrnas,
                      "df_allgenes_tpm_anno": gv.df_allgenes_tpm_anno,
                      "inputDir": gv.inputDir,
                      "outputDir": gv.outputDir,
                      "take_log2_tpm_forNNwTFs": gv.take_log2_tpm,
                      "use_random_wts": gv.use_random_wts,
                      "use_corr_wts": gv.use_corr_wts,
                      "use_expDecay_wts": gv.use_expDecay_wts,
                      "take_top_fts": gv.take_top_fts,
                      "take_this_many_top_fts": gv.take_this_many_top_fts,
                      "tf_corr_threshold_high": gv.tf_corr_threshold_high,
                      "tf_corr_threshold_low": gv.tf_corr_threshold_low,
                      "enforce_corr_thresholding": args.enforce_corr_thresholding,  # if True, corr thresholding enforced for random TFs
                      "frac_test": args.frac_test,
                      "get_random_TFs": gv.use_random_TFs,
                      "to_seed": args.to_seed}
